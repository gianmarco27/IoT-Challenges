...
#line 260
extern double erfc(double arg_0xb7b8e8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a38840), 
int (*key_eq_fn)(void *arg_0xb7a38c88, void *arg_0xb7a38e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79079b8, int arg_0xb7907b10);
static double RandomUniform(void );
...
typedef uint16_t sendAckC$sensorRead$val_t;
...
static void sendAckC$sensorRead$readDone(error_t result, sendAckC$sensorRead$val_t val);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t sendAckC$sensorRead$read(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$MilliTimer$startPeriodic(uint32_t dt);
#line 78
static void sendAckC$MilliTimer$stop(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t sendAckC$pack_ack$requestAck(
#line 53
message_t * msg);
#line 85
static bool sendAckC$pack_ack$wasAcked(
#line 80
message_t * msg);
# 28 "sendAckC.nc"
...
#line 163
static inline void sendAckC$sensorRead$readDone(error_t result, uint16_t data);
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t sendAckC$sensorRead$read(void ){
#line 55
...
#line 151
      ...
      sim_log_debug(162U, "radio_rcv", "Packet received...");
      sim_log_debug(163U, "radio_rcv", "\t\t type: %hhu \n", __nesc_ntoh_uint8(msg->type.nxdata));
      sim_log_debug(164U, "radio_rcv", "\t\t counter: %hhu \n", __nesc_ntoh_uint16(msg->counter.nxdata));
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76abac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76abac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76abac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76a8178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76a8178, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76ab108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76ab108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73aeca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73aeca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73aeca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7863650){
#line 75
  switch (arg_0xb7863650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7863650);
#line 75
      break;
#line 75
    }
...
inline static bool sendAckC$pack_ack$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73ab730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73ab730, addr, msg, len);
#line 80
...
#line 80
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t sendAckC$pack_ack$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
#line 44
  ...
  sendAckC$pack_ack$requestAck(&sendAckC$packet[sim_node()]);
...
#line 172
  ...
  sim_log_debug(165U, "radio_pack", "Preparing the message... \n");
  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(166U, "radio_send", "Packet passed to lower layer successfully!\n");
      ...
      sim_log_debug_clear(170U, "radio_pack", "\t\t counter: %hhu \n", __nesc_ntoh_uint16(msg->counter.nxdata));
      sim_log_debug_clear(171U, "radio_pack", "\t\t value: %hhu \n", __nesc_ntoh_uint16(msg->value.nxdata));
    }
}
...
#line 63
  sendAckC$sensorRead$readDone(result, val);
#line 63
}
#line 63
# 24 "FakeSensorP.nc"
...
#line 114
  if (buf == &sendAckC$packet[sim_node()] && err == SUCCESS) {
      sim_log_debug(155U, "radio_send", "Packet sent...\n");
      sim_log_debug(156U, "radio_send", "\t\t type: %hhu \n", __nesc_ntoh_uint8(msg->type.nxdata));
      sim_log_debug(157U, "radio_send", "\t\t counter: %hhu \n", __nesc_ntoh_uint16(msg->counter.nxdata));
      sim_log_debug(158U, "radio_send", "\t\t value: %hhu \n", __nesc_ntoh_uint16(msg->value.nxdata));
      if (sendAckC$pack_ack$wasAcked(&sendAckC$packet[sim_node()])) {
          sim_log_debug(159U, "radio_send", "Message acked.\n");
          if (TOS_NODE_ID == 1) {
...
#line 124
        {
          if (TOS_NODE_ID == 2) {
              sim_log_debug(160U, "radio_send", "Message not acked, repeating send..\n");
              sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t ));
            }
        }
    }
  else 
    {
      sim_log_error(161U, "radio_send", "Send done error!");
    }
}
